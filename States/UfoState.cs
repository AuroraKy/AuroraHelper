...
namespace Celeste.Mod.AurorasHelper
{
    public class UfoState {
        ...
        public static int Update()
        {
            ...
            //TrailManager.Add(sd.PlayerSpriteReplacement.fakeSpriteEntity, scale, Color.Orange, 1f);
            return StateNumber;
        }
        ...
        public static void Begin()
        {
            ...
            Sprite replacement = GFX.SpriteBank.Create("aurorahelper_madelineModeUfo");
