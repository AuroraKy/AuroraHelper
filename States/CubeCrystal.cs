...
{
    [CustomEntity("AurorasHelper/CubeCrystal")]
    class CubeCrystal : Entity
    {
        ...
        public CubeCrystal(EntityData data, Vector2 offset) : base(data.Position + offset)
		{
		...
		public static void OnLeaveCrystalState()
		{
            ...
            if (session.isInFakeModeState && session.currentState == AurorasHelperSession.STATE.Cube)
            {
