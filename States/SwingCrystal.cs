...
{
    [CustomEntity("AurorasHelper/SwingCrystal")]
    class SwingCrystal : Entity
    {
		...
		private readonly SwingState.DIR dir;
        ...
        public SwingCrystal(EntityData data, Vector2 offset) : base(data.Position + offset)
		{
			...
			this.Visible = !data.Bool("Invisible", false);
            string spritePrefix = data.Attr("Sprite", "objects/auroras_helper/mode_crystals/Swing_crystal/");
            dir = (SwingState.DIR)data.Int("Dir", 1);
            ...
            Color color1 = Calc.HexToColor("ffff32");
			Color color2 = Calc.HexToColor("cccc28");
