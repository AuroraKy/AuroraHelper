...
{
    [CustomEntity("AurorasHelper/SpiderCrystal")]
    class SpiderCrystal : Entity
    {
		...
		private readonly SpiderState.DIR dir;
        ...
        public SpiderCrystal(EntityData data, Vector2 offset) : base(data.Position + offset)
		{
            ...
            string spritePrefix = data.Attr("Sprite", "objects/auroras_helper/mode_crystals/spider_crystal/");
            dir = (SpiderState.DIR)data.Int("Dir", 1);
            ...
            Color color1 = Calc.HexToColor("ae28ff");
			Color color2 = Calc.HexToColor("4217ff");
