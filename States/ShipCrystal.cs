...
{
    [CustomEntity("AurorasHelper/ShipCrystal")]
    class ShipCrystal : Entity
    {
		...
		private readonly ShipState.DIR dir;
		private readonly float speedX;
		private float respawnTimer;

		private Level level;

        public ShipCrystal(EntityData data, Vector2 offset) : base(data.Position + offset)
		{
			base.Collider = new Hitbox(16f, 16f, -8f, -8f);

			speedX = data.Float("speedX", 200f);

            String spritePrefix = data.Attr("Sprite", "objects/auroras_helper/mode_crystals/ship_crystal/");
            dir = (ShipState.DIR)data.Int("Dir", 1);
            ...
            Color color1 = Calc.HexToColor("c440ca");
			Color color2 = Calc.HexToColor("ea83ef");
